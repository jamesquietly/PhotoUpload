...
class UserViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        photoLabel.font = UIFont(name: "HelveticaNeue-Bold", size: 18)
        ...
        let views = ["userLabel": userLabel, "panelLabel": panelLabel,
                     "photoLabel": photoLabel, "signOutButton":signOutButton]
        ...
        constraints += NSLayoutConstraint.constraints(withVisualFormat: "[photoLabel]", options: [], metrics: metrics, views: views)
        ...
        constraints += NSLayoutConstraint.constraints(withVisualFormat: "V:|-50-[userLabel(high50)]-[panelLabel(high50)]-[photoLabel(high50)]-[signOutButton(high50)]", options: [], metrics: metrics, views: views)
